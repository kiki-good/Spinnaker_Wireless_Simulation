...
INT_HANDLER cc_rx_ready_isr (void)
{
  ...
  io_printf(IO_BUF, "cc_rx_ready_isr is triggered....\n");
...
INT_HANDLER cc_rx_ready_fiqsr ()
{
  ...
  //io_printf(IO_BUF, "cc_rx_ready_fiqsr is triggered\n");
...
INT_HANDLER cc_rx_error_isr ()
{
  ...
  io_printf(IO_BUF, "cc_rx_error_isr.........\n");
...
INT_HANDLER buffer_full_isr()
{
	io_printf(IO_BUF, "buffer_full_isr.........\n");
