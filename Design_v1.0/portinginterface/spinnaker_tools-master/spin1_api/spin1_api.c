...
*  $HeadURL: https://solem.cs.man.ac.uk/svn/spin1_api/trunk/src/spin1_api.c $
*
* COPYRIGHT
...
extern INT_HANDLER buffer_full_isr(void);
...
//Monitor errors
    // configure the software interrupt
  vic_vectors[DEBUG_BUFFER_FULL]  = buffer_full_isr;
  vic_controls[DEBUG_BUFFER_FULL] = 0x20 | CC_TFL_INT;
...
void spin1_callback_on (uint event_id, callback_t cback, int priority)
{
  ...
  //io_printf(IO_BUF, "spin1_callback_on is called: TASK_QUEUE_SIZE %d\n",TASK_QUEUE_SIZE);
