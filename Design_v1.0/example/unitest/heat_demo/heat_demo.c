...
void send_temps_to_host ()
{
  ...
  io_printf (IO_BUF, "send_temps_to_host\n");
...
{ 
  ...
  /* JM_DEBUG */
  io_printf (IO_BUF, "Receive Counter %d\n", sark.vcpu->user1);
...
void c_main()
{
  ...
  io_printf(IO_BUF,"coreID is %d\n",coreID);  
  io_printf(IO_BUF,"chipID is %d\n",chipID);
  ...
  {  	
	io_printf(IO_BUF,"core map entered!\n");	
